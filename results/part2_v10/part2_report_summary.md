...
- `3bit_problem1`: mean best-of-run=37.200, std=25.823
- `7bit_problem1`: mean best-of-run=38.600, std=24.677
- `3bit_problem2`: mean best-of-run=-61.693, std=27.330
- `7bit_problem2`: mean best-of-run=-83.049, std=17.452
...
- `problem1` best condition `problem1_3bit_pop200_t5` -> `E:\CE310\results\part2_v10\task8_primitives\problem1_primitive_trends.png`
- `problem2` best condition `problem2_3bit_pop200_t3` -> `E:\CE310\results\part2_v10\task8_primitives\problem2_primitive_trends.png`
